...
def show_login():
    ...
    <div class="login-card">
        ...
        <div class="login-title">LYNSUS</div>
        <div class="login-subtitle">CONTRACTOR SUITE</div>
    </div>
    """, unsafe_allow_html=True)

    col_left, col_center, col_right = st.columns([1, 2, 1])
    with col_center:
        email = st.text_input("Email", placeholder="you@email.com", key="login_email", label_visibility="collapsed")
        ...
        st.markdown("<div style='text-align:center; color:#94a3b8; font-size:11px;'>Powered by Lynsus Consulting LLC</div>", unsafe_allow_html=True)
